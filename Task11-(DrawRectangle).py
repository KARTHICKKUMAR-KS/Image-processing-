...
def mouseClick(event,xPos,yPos,flags,param):
 ...
 # Global variables shared between the mouseClick function and rest ofthe codeglobal draw,p1,p2
 global draw,p1,p2
 ...
 if event==cv2.EVENT_LBUTTONDOWN:
   ...
   p1 = (xPos,yPos)
   p2 = p1
 # Continuously update bottom right cornor point (p2) of rectangle onmouse move event
...
while True:
  frame = np.zeros((500,500,3), np.uint8) # renew black frame in everyloop (this simulates a video)
